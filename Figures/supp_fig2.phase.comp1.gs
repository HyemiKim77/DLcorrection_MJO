...
'draw string 1.0 10.65 a. ECMWF-Cy43r3'
'draw string 1.0 8.15 b. NCAR-CESM1'
'draw string 1.0 5.65 c. NASA-GEOS5'
'draw string 1.0 3.15 d. Navy-ESPC'
'set strsiz 0.09'
'set string 1 c 3 90'
...
'set string 1 c 3 0'
'set string 1 l 3'
'draw string 1. 8.9 `1 OBS'
'set string 4 l 3'
'draw string 1. 8.75 `1 S2S'
'set string 2 l 3'
'draw string 1. 8.6 `1 DL'
...
'print'
'disable print'
'!gxps -c -i case.gx -o ./fig/supp_fig1.phase_comp1.ps'
