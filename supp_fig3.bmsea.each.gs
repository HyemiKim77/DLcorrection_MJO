...
'open  /usr/hkim/nature_comm/data/ecmwf/sig/bmsea.lev95.ctl'
'open  /usr/hkim/nature_comm/data/cesm/sig/bmsea.lev95.ctl'

'set string 1 l 4'
'set strsiz 0.12'
'draw string 3.7 10.9 BMSEa'
'set strsiz 0.09'
...
'define b1= tloop(ave(bmsea.1,t+0,t+2))'
'define b2= tloop(ave(bmsea.2,t+0,t+2))'
...
'set clevs  -12 -10 -8 -6 -4 -2 -1.0 1.0 2  4  6 8 10 12'
'set ccols  37 36 35 34 33 32 31   20 41 42 43 44 45 46 47'
'define b1= tloop(ave(bmsea.3,t+0,t+2))'
'define b2= tloop(ave(bmsea.4,t+0,t+2))'
'd b1*100'
...
'set clevs  -12 -10 -8 -6 -4 -2 -1.0 1.0 2  4  6 8 10 12'
'set ccols  37 36 35 34 33 32 31   20 41 42 43 44 45 46 47'
'define b1= tloop(ave(bmsea.5,t+0,t+2))'
'define b2= tloop(ave(bmsea.6,t+0,t+2))'
'd b1*100'
...
'set clevs  -12 -10 -8 -6 -4 -2 -1.0 1.0 2  4  6 8 10 12'
'set ccols  37 36 35 34 33 32 31   20 41 42 43 44 45 46 47'
'define b1= tloop(ave(bmsea.7,t+0,t+2))'
'define b2= tloop(ave(bmsea.8,t+0,t+2))'
'd b1*100'
...
'set clevs  -12 -10 -8 -6 -4 -2 -1.0 1.0 2  4  6 8 10 12'
'set ccols  37 36 35 34 33 32 31   20 41 42 43 44 45 46 47'
'define b1= tloop(ave(bmsea.9,t+0,t+2))'
'define b2= tloop(ave(bmsea.10,t+0,t+2))'
'd b1*100'
...
'set clevs  -12 -10 -8 -6 -4 -2 -1.0 1.0 2  4  6 8 10 12'
'set ccols  37 36 35 34 33 32 31   20 41 42 43 44 45 46 47'
'define b1= tloop(ave(bmsea.11,t+0,t+2))'
'define b2= tloop(ave(bmsea.12,t+0,t+2))'
'd b1*100'
...
'set clevs  -12 -10 -8 -6 -4 -2 -1.0 1.0 2  4  6 8 10 12'
'set ccols  37 36 35 34 33 32 31   20 41 42 43 44 45 46 47'
'define b1= tloop(ave(bmsea.13,t+0,t+2))'
'define b2= tloop(ave(bmsea.14,t+0,t+2))'
'd b1*100'
...
'set clevs  -12 -10 -8 -6 -4 -2 -1.0 1.0 2  4  6 8 10 12'
'set ccols  37 36 35 34 33 32 31   20 41 42 43 44 45 46 47'
'define b1= tloop(ave(bmsea.15,t+0,t+2))'
'define b2= tloop(ave(bmsea.16,t+0,t+2))'
'd b1*100'
...
'set display white'
'gxprint supp_fig2.bmsea.each.eps'
'gxprint case.ps'
'!convert -trim -scale 50% -density 300 case.ps supp_fig2.bmsea.each.png'
